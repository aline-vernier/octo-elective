...
En résolvant numériquement cette équation pour une impulsion laser de la forme $a(t) = a_0\mathrm{e}^{-t/\tau}$ on a alors une oscillation du potentiel et donc du champ qui en dérive, représentés sur la Figure~\ref{}.
