...
\noindent\fcolorbox{black}{myGray}{%
    \minipage[t]{\dimexpr1\linewidth-2\fboxsep-2\fboxrule\relax}
        \textbf{Calculs de la taille et de la position du waist en cavité :\\}
            Soit une cavité linéaire de longueur $L$ et dont les miroirs sont de courbures $R_1$ et $R_2$ telle que sur la Figure~\ref{fig:cell}s
          \\
          \\
          \begin{itemize}
...
Les années '90 ont connu l'essor des lasers basés sur l'amplification laser dans des cristaux de saphir dopés au titane, plus connus sous le nom de Titane-Saphir, par amplification par dérive de fréquence - ou Chirped Pulse Amplification (CPA) en anglais-. Cette technique a permis de multiplier par près de trois ordres de grandeur la puissance crête des lasers, et par conséquent d'accéder au régime d'interaction laser-plasma relativiste. Plusieurs groupes dans le monde (le LBNL à Berkeley, l'Imperial College à Londres, et le LOA à Palaiseau) ont ainsi pu, et ce presque simultanément, accélérer des électrons à des énergies relativistes par interaction entre un laser et un plasma généré dans un gaz. 
