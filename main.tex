...
\includegraphics[width=8cm]{}
\end{center}
\caption{Espace des phases pour un oscillateur harmonique}
...
Cette équation décrit les trajectoires des électrons dans l'onde de sillage en fonction de leur condition initiale $H_0$. Supposons maintenant que le potentiel électrostatique est de la forme $\phi=\phi_0\cos{(\omega_p \zeta)}$. Nous pouvons alors tracer les trajectoires des particules dans l'espace des phases $\gamma(\zeta)$.
