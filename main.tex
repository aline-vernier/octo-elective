...
Il est assez clair que l'un des facteurs limitants est la taille des structures accélératrices. C'est le problème que l'accélération laser-plasma pourrait permettre de résoudre. 


\section{L'accélération par interaction laser-plasma}

L'idée de base de l'utilisation des champs présents dans un plasma pour accélérer des électrons 
