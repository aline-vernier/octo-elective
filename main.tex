...
En fin de chaîne, après recompression de l'impulsion, le laser est focalisé par un réflecteur parabolique (souvenez-vous du premier cours, c'est la seule surface parfaitement stigmatique...) sur une cible de gaz dans laquelle le plasma est généré, comme présenté schématiquement sur la Figure~\ref{}

\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=14cm]{pictures/}
\end{center}
