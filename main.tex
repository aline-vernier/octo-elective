...
\end{center}
\caption{Potentiel coulombien et effet du champ laser sur le potentiel. En bleu sombre : potentiel non-perturbé. En augmentant l'intensité du champ, on augmente la probabilité d'ionisation par effet tunnel, jusqu'à la suppression de barrière }
\label{fig:potentiel}
\end{figure}
